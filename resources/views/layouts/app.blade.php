                        ...
                        <div class="popup-list">
                            <div class="notify-item unread">
                                ...
                                <div class="notify-content">
                                    <p class="notify-text"><strong>Анна</strong> прокомментировала вашу задачу</p>
                                    <span class="notify-time">10 мин. назад</span>
                                </div>
                            </div>

                            <div class="notify-item">
                                <div class="notify-avatar" style="background: #e0e0e0;">MK</div>
                                <div class="notify-content">
                                    <p class="notify-text">Загрузка файла завершена</p>
                                    <span class="notify-time">1 час назад</span>
                                </div>
                            </div>
                        </div>
